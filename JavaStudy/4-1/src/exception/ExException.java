...
public class ExException {
        ...
        do {
            ...
            try {
                ...
                switch (parameter) {
                    ...
                    // ここへ記述
                    	if (parameter>3 ) {
							System.out.print(CONST_COMMON_MSG_ERROR_EXCEPTION);
                    	}
                    	else if(parameter<1) {
                    		System.out.print(CONST_COMMON_MSG_ERROR_EXCEPTION);
                    	}
     ...
     */
    // ここへ記述
    private static void NPE() throws CONST_EXCEPTION_TRIGER_NULL,CONST_EXCEPTION_TRIGER_ARRAY_OUT_OF_BOUNDS,CONST_EXCEPTION_TRIGER_CAS {
    	System.out.print(CONST_COMMON_MSG_ERROR_EXCEPTION);
    }
